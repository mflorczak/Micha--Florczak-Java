package com.kodilla.patterns2.decorator.raxiportal;
...
public class TaxiOrderTestSuite {
    ...
    public void testMyTaxiWithChildSeatGetCost() {
        //Given
        TaxiOrder theOrder = new BasicTaxiOrder();
        theOrder = new MyTaxiOderDecorator(theOrder);
    ...
    public void testVipTaxiWithChildSeatExpressGetCost() {
        //Given
        TaxiOrder theOrader = new BasicTaxiOrder();
        theOrader = new TaxiNetworkOrderDecorator(theOrader);
        theOrader = new VipCarDecorator(theOrader);
        theOrader = new ChildSeatDecorator(theOrader);
        theOrader = new ExpressDecorator(theOrader);
        System.out.println(theOrader.getCost());

        //When
        BigDecimal theCost = theOrader.getCost();
